# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 17:59:12 2022
...
from data_generating_nonlinear_line import IS
from data_generating_nonlinear_line import test
import random
...
save_path=""
agent=PPO_RB(size=32,rest=6,shape="circle",sensor_pos="line",sample_size=500,freq_bound=32,num_freq=4,state_dim=12,action_dim=360,
             hidden_cell=(256,64),n_layers=(3,2),save_path=save_path,load_path="")
load_path = "C:/Users/scottjhy/Desktop/RL inverse scattering/code/inverse scattering fixed frequency code/630"
